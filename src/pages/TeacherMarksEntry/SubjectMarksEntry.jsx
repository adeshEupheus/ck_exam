...
import { Collapse, IconButton, Skeleton, TablePagination } from "@mui/material";
...
import { GetExamConfigData as GetExamConfig } from "../../apis/fetcher/TeacherMarksEntry/Overview";
import SwitchLabels from "../../Components/Material/Switch";
import { GetSubjectMarksEntry } from "../../apis/fetcher/TeacherMarksEntry/subjectMarksEntry";
import {
  EditMarks,
  ToggleMarksEntry,
  UpdateAttendance,
} from "../../apis/mutation/TeacherMarksEntry/marksEntry";
...
import { GetAnswerKeyStatus } from "../../apis/fetcher/TeacherMarksEntry/subjectMarksEntry";
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      if (data.name === "toggleLock_marksEntry") {
        ...
        const res = await ToggleMarksEntry(bodyFormData);
        // console.log(res);
        if (res.status === 200) {
                ...
                <BasicButton
                  ...
                  handleButtonAction={async () => {
                    const res = await instance({
                      url: `liveApp/api/v1/previewAnswerKeyForSM/${sectionId}/${id}/${subjectId}`,
                      method: "GET",
                      headers: {
