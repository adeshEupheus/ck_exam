        ...
        >
          ...
          <div className="relative flex flex-col w-full justify-center items-start gap-4 bg-gray-200">
            <div className="sm:px-8 px-4 w-full flex flex-col gap-4 mb-4">
              <Breadcrumbs crumbs={["Revision & Exam", "Personal Revision Sheet"]} />
              <h1 className="font-semibold sm:text-2xl text-xl">PERSONAL REVISION SHEET</h1>
              {isLoading ? (
                <Skeleton
                  animation="wave"
                  variant="text"
              ...
              {isLoading ? (
                ...
                <div><img src="https://classklap-assets.s3.ap-south-1.amazonaws.com/assets/reportCardIcons/Maths.svg" alt="image" className=" w-[4rem] h-[5rem]  sm:mt-0  "></img>
                </div>
                <RevisionBar/>
                  </div>
                  <div className="flex w-full gap-2 p-2 bg-slate-300">
                  <div><img src="https://classklap-assets.s3.ap-south-1.amazonaws.com/assets/reportCardIcons/English.svg" alt="image" className=" w-[4rem] h-[5rem]  sm:mt-0 "></img>
                  </div>
                  <RevisionBar/>
                    </div>
                    </>
